...
(cl:defmethod cl:initialize-instance :after ((m <PumpStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PumpStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecharm_communication-srv:<PumpStatus-request> is deprecated: use mecharm_communication-srv:PumpStatus-request instead.")))

(cl:ensure-generic-function 'Status-val :lambda-list '(m))
(cl:defmethod Status-val ((m <PumpStatus-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:Status-val is deprecated.  Use mecharm_communication-srv:Status instead.")
  (Status m))

(cl:ensure-generic-function 'Pin1-val :lambda-list '(m))
(cl:defmethod Pin1-val ((m <PumpStatus-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:Pin1-val is deprecated.  Use mecharm_communication-srv:Pin1 instead.")
  (Pin1 m))

(cl:ensure-generic-function 'Pin2-val :lambda-list '(m))
(cl:defmethod Pin2-val ((m <PumpStatus-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:Pin2-val is deprecated.  Use mecharm_communication-srv:Pin2 instead.")
  (Pin2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PumpStatus-request>)))
  ...
  "mecharm_communication/PumpStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PumpStatus-request)))
  "Returns string type for a service object of type 'PumpStatus-request"
  "mecharm_communication/PumpStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <PumpStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PumpStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecharm_communication-srv:<PumpStatus-response> is deprecated: use mecharm_communication-srv:PumpStatus-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PumpStatus-response>)))
  ...
  "mecharm_communication/PumpStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PumpStatus-response)))
  "Returns string type for a service object of type 'PumpStatus-response"
  "mecharm_communication/PumpStatusResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PumpStatus)))
  ...
  "mecharm_communication/PumpStatus")