...
(cl:defmethod cl:initialize-instance :after ((m <SetCoords-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCoords-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecharm_communication-srv:<SetCoords-request> is deprecated: use mecharm_communication-srv:SetCoords-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:x-val is deprecated.  Use mecharm_communication-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:y-val is deprecated.  Use mecharm_communication-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:z-val is deprecated.  Use mecharm_communication-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'rx-val :lambda-list '(m))
(cl:defmethod rx-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:rx-val is deprecated.  Use mecharm_communication-srv:rx instead.")
  (rx m))

(cl:ensure-generic-function 'ry-val :lambda-list '(m))
(cl:defmethod ry-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:ry-val is deprecated.  Use mecharm_communication-srv:ry instead.")
  (ry m))

(cl:ensure-generic-function 'rz-val :lambda-list '(m))
(cl:defmethod rz-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:rz-val is deprecated.  Use mecharm_communication-srv:rz instead.")
  (rz m))
...
(cl:defmethod model-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:model-val is deprecated.  Use mecharm_communication-srv:model instead.")
  (model m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCoords-request>)))
  ...
  "mecharm_communication/SetCoordsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCoords-request)))
  "Returns string type for a service object of type 'SetCoords-request"
  "mecharm_communication/SetCoordsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetCoords-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCoords-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecharm_communication-srv:<SetCoords-response> is deprecated: use mecharm_communication-srv:SetCoords-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCoords-response>)))
  ...
  "mecharm_communication/SetCoordsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCoords-response)))
  "Returns string type for a service object of type 'SetCoords-response"
  "mecharm_communication/SetCoordsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCoords)))
  ...
  "mecharm_communication/SetCoords")