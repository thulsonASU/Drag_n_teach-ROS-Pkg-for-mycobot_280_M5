...
(cl:defmethod cl:initialize-instance :after ((m <MycobotSetCoords>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MycobotSetCoords)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecharm_communication-msg:<MycobotSetCoords> is deprecated: use mecharm_communication-msg:MycobotSetCoords instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <MycobotSetCoords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-msg:x-val is deprecated.  Use mecharm_communication-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <MycobotSetCoords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-msg:y-val is deprecated.  Use mecharm_communication-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <MycobotSetCoords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-msg:z-val is deprecated.  Use mecharm_communication-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'rx-val :lambda-list '(m))
(cl:defmethod rx-val ((m <MycobotSetCoords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-msg:rx-val is deprecated.  Use mecharm_communication-msg:rx instead.")
  (rx m))

(cl:ensure-generic-function 'ry-val :lambda-list '(m))
(cl:defmethod ry-val ((m <MycobotSetCoords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-msg:ry-val is deprecated.  Use mecharm_communication-msg:ry instead.")
  (ry m))

(cl:ensure-generic-function 'rz-val :lambda-list '(m))
(cl:defmethod rz-val ((m <MycobotSetCoords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-msg:rz-val is deprecated.  Use mecharm_communication-msg:rz instead.")
  (rz m))
...
(cl:defmethod model-val ((m <MycobotSetCoords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-msg:model-val is deprecated.  Use mecharm_communication-msg:model instead.")
  (model m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MycobotSetCoords>)))
  ...
  "mecharm_communication/MycobotSetCoords")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MycobotSetCoords)))
  "Returns string type for a message object of type 'MycobotSetCoords"
  "mecharm_communication/MycobotSetCoords")
