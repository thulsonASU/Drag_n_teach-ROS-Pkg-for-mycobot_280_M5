...
(cl:in-package mecharm_communication-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetAngles-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAngles-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecharm_communication-srv:<SetAngles-request> is deprecated: use mecharm_communication-srv:SetAngles-request instead.")))

(cl:ensure-generic-function 'joint_1-val :lambda-list '(m))
(cl:defmethod joint_1-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:joint_1-val is deprecated.  Use mecharm_communication-srv:joint_1 instead.")
  (joint_1 m))

(cl:ensure-generic-function 'joint_2-val :lambda-list '(m))
(cl:defmethod joint_2-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:joint_2-val is deprecated.  Use mecharm_communication-srv:joint_2 instead.")
  (joint_2 m))

(cl:ensure-generic-function 'joint_3-val :lambda-list '(m))
(cl:defmethod joint_3-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:joint_3-val is deprecated.  Use mecharm_communication-srv:joint_3 instead.")
  (joint_3 m))

(cl:ensure-generic-function 'joint_4-val :lambda-list '(m))
(cl:defmethod joint_4-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:joint_4-val is deprecated.  Use mecharm_communication-srv:joint_4 instead.")
  (joint_4 m))

(cl:ensure-generic-function 'joint_5-val :lambda-list '(m))
(cl:defmethod joint_5-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:joint_5-val is deprecated.  Use mecharm_communication-srv:joint_5 instead.")
  (joint_5 m))

(cl:ensure-generic-function 'joint_6-val :lambda-list '(m))
(cl:defmethod joint_6-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:joint_6-val is deprecated.  Use mecharm_communication-srv:joint_6 instead.")
  (joint_6 m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:speed-val is deprecated.  Use mecharm_communication-srv:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetAngles-request>)))
  ...
  "mecharm_communication/SetAnglesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles-request)))
  "Returns string type for a service object of type 'SetAngles-request"
  "mecharm_communication/SetAnglesRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetAngles-request>)))
  ...
  "55187c842c58f84693a24ea9acdaa608")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetAngles-request)))
  "Returns md5sum for a message object of type 'SetAngles-request"
  "55187c842c58f84693a24ea9acdaa608")
...
(cl:defmethod cl:initialize-instance :after ((m <SetAngles-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAngles-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mecharm_communication-srv:<SetAngles-response> is deprecated: use mecharm_communication-srv:SetAngles-response instead.")))

(cl:ensure-generic-function 'Flag-val :lambda-list '(m))
(cl:defmethod Flag-val ((m <SetAngles-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mecharm_communication-srv:Flag-val is deprecated.  Use mecharm_communication-srv:Flag instead.")
  (Flag m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetAngles-response>)))
  ...
  "mecharm_communication/SetAnglesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles-response)))
  "Returns string type for a service object of type 'SetAngles-response"
  "mecharm_communication/SetAnglesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles)))
  ...
  "mecharm_communication/SetAngles")