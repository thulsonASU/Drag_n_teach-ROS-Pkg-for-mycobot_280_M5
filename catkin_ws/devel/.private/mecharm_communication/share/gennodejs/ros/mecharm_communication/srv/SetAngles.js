...
// (in-package mecharm_communication.srv)
...
class SetAnglesResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'mecharm_communication/SetAnglesResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '55187c842c58f84693a24ea9acdaa608'; },
  datatype() { return 'mecharm_communication/SetAngles'; }
};
