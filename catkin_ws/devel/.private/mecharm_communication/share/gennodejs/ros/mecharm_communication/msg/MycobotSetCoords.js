...
class MycobotSetCoords {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MycobotSetCoords(null);
  ...
  static datatype() {
    ...
    return 'mecharm_communication/MycobotSetCoords';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MycobotSetCoords(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = MycobotSetCoords;
