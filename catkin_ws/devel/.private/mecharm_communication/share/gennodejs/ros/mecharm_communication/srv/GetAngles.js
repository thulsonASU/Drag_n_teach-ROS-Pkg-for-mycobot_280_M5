...
class GetAnglesRequest {
  ...
  static datatype() {
    ...
    return 'mecharm_communication/GetAnglesRequest';
  }
...
class GetAnglesResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'mecharm_communication/GetAnglesResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '8ce9dd71b812ac669ff127f95e5ce8ab'; },
  datatype() { return 'mecharm_communication/GetAngles'; }
};
