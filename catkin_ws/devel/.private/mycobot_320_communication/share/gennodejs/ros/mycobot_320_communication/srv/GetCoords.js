...
class GetCoordsRequest {
  ...
  static datatype() {
    ...
    return 'mycobot_320_communication/GetCoordsRequest';
  }
...
class GetCoordsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'mycobot_320_communication/GetCoordsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'mycobot_320_communication/GetCoords'; }
};
