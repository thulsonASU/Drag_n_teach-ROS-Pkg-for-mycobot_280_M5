...
(cl:defmethod cl:initialize-instance :after ((m <SetCoords-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCoords-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mycobot_320_communication-srv:<SetCoords-request> is deprecated: use mycobot_320_communication-srv:SetCoords-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-srv:x-val is deprecated.  Use mycobot_320_communication-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-srv:y-val is deprecated.  Use mycobot_320_communication-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-srv:z-val is deprecated.  Use mycobot_320_communication-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'rx-val :lambda-list '(m))
(cl:defmethod rx-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-srv:rx-val is deprecated.  Use mycobot_320_communication-srv:rx instead.")
  (rx m))

(cl:ensure-generic-function 'ry-val :lambda-list '(m))
(cl:defmethod ry-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-srv:ry-val is deprecated.  Use mycobot_320_communication-srv:ry instead.")
  (ry m))

(cl:ensure-generic-function 'rz-val :lambda-list '(m))
(cl:defmethod rz-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-srv:rz-val is deprecated.  Use mycobot_320_communication-srv:rz instead.")
  (rz m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-srv:speed-val is deprecated.  Use mycobot_320_communication-srv:speed instead.")
  (speed m))

(cl:ensure-generic-function 'model-val :lambda-list '(m))
(cl:defmethod model-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-srv:model-val is deprecated.  Use mycobot_320_communication-srv:model instead.")
  (model m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCoords-request>)))
  ...
  "mycobot_320_communication/SetCoordsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCoords-request)))
  "Returns string type for a service object of type 'SetCoords-request"
  "mycobot_320_communication/SetCoordsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetCoords-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCoords-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mycobot_320_communication-srv:<SetCoords-response> is deprecated: use mycobot_320_communication-srv:SetCoords-response instead.")))

(cl:ensure-generic-function 'Flag-val :lambda-list '(m))
(cl:defmethod Flag-val ((m <SetCoords-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-srv:Flag-val is deprecated.  Use mycobot_320_communication-srv:Flag instead.")
  (Flag m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCoords-response>)))
  ...
  "mycobot_320_communication/SetCoordsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCoords-response)))
  "Returns string type for a service object of type 'SetCoords-response"
  "mycobot_320_communication/SetCoordsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCoords)))
  ...
  "mycobot_320_communication/SetCoords")