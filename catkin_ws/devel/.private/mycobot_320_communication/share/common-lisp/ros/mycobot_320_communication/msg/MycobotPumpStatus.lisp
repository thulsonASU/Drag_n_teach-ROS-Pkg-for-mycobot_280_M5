...
(cl:defmethod cl:initialize-instance :after ((m <MycobotPumpStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MycobotPumpStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mycobot_320_communication-msg:<MycobotPumpStatus> is deprecated: use mycobot_320_communication-msg:MycobotPumpStatus instead.")))

(cl:ensure-generic-function 'Status-val :lambda-list '(m))
(cl:defmethod Status-val ((m <MycobotPumpStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-msg:Status-val is deprecated.  Use mycobot_320_communication-msg:Status instead.")
  (Status m))

(cl:ensure-generic-function 'Pin1-val :lambda-list '(m))
(cl:defmethod Pin1-val ((m <MycobotPumpStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-msg:Pin1-val is deprecated.  Use mycobot_320_communication-msg:Pin1 instead.")
  (Pin1 m))

(cl:ensure-generic-function 'Pin2-val :lambda-list '(m))
(cl:defmethod Pin2-val ((m <MycobotPumpStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_320_communication-msg:Pin2-val is deprecated.  Use mycobot_320_communication-msg:Pin2 instead.")
  (Pin2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MycobotPumpStatus>)))
  ...
  "mycobot_320_communication/MycobotPumpStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MycobotPumpStatus)))
  "Returns string type for a message object of type 'MycobotPumpStatus"
  "mycobot_320_communication/MycobotPumpStatus")
