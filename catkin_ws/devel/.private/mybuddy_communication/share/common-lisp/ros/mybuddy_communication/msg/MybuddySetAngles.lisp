...
(cl:defclass <MybuddySetAngles> (roslisp-msg-protocol:ros-message)
  ((joint_0
    :reader joint_0
    :initarg :joint_0
    :type cl:float
...
(cl:defclass MybuddySetAngles (<MybuddySetAngles>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MybuddySetAngles>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MybuddySetAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mybuddy_communication-msg:<MybuddySetAngles> is deprecated: use mybuddy_communication-msg:MybuddySetAngles instead.")))

(cl:ensure-generic-function 'joint_0-val :lambda-list '(m))
(cl:defmethod joint_0-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_1-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_2-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_3-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_4-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_5-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_6-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_7-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_8-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_9-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_10-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_11-val ((m <MybuddySetAngles>))
...
(cl:defmethod joint_12-val ((m <MybuddySetAngles>))
...
(cl:defmethod speed-val ((m <MybuddySetAngles>))
  ...
  (speed m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MybuddySetAngles>) ostream)
  "Serializes a message object of type '<MybuddySetAngles>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MybuddySetAngles>) istream)
  "Deserializes a message object of type '<MybuddySetAngles>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MybuddySetAngles>)))
  "Returns string type for a message object of type '<MybuddySetAngles>"
  "mybuddy_communication/MybuddySetAngles")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MybuddySetAngles)))
  "Returns string type for a message object of type 'MybuddySetAngles"
  "mybuddy_communication/MybuddySetAngles")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MybuddySetAngles>)))
  "Returns md5sum for a message object of type '<MybuddySetAngles>"
  "769c6674f9b0a0d97950c00b6fe8b517")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MybuddySetAngles)))
  "Returns md5sum for a message object of type 'MybuddySetAngles"
  "769c6674f9b0a0d97950c00b6fe8b517")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MybuddySetAngles>)))
  "Returns full string definition for message of type '<MybuddySetAngles>"
  (cl:format cl:nil "# float32 joint_1~%# float32 joint_2~%# float32 joint_3~%# float32 joint_4~%# float32 joint_5~%# float32 joint_6~%float32 joint_0~%float32 joint_1~%float32 joint_2~%float32 joint_3~%float32 joint_4~%float32 joint_5~%float32 joint_6~%float32 joint_7~%float32 joint_8~%float32 joint_9~%float32 joint_10~%float32 joint_11~%float32 joint_12~%~%int8 speed~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MybuddySetAngles)))
  "Returns full string definition for message of type 'MybuddySetAngles"
  (cl:format cl:nil "# float32 joint_1~%# float32 joint_2~%# float32 joint_3~%# float32 joint_4~%# float32 joint_5~%# float32 joint_6~%float32 joint_0~%float32 joint_1~%float32 joint_2~%float32 joint_3~%float32 joint_4~%float32 joint_5~%float32 joint_6~%float32 joint_7~%float32 joint_8~%float32 joint_9~%float32 joint_10~%float32 joint_11~%float32 joint_12~%~%int8 speed~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MybuddySetAngles>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MybuddySetAngles>))
  "Converts a ROS message object to a list"
  (cl:list 'MybuddySetAngles
