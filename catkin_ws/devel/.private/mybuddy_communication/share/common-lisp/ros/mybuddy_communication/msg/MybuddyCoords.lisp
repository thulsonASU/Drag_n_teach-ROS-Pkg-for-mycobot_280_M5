...
;//! \htmlinclude MybuddyCoords.msg.html

(cl:defclass <MybuddyCoords> (roslisp-msg-protocol:ros-message)
  ((x
    :reader x
    :initarg :x
    :type cl:float
...
(cl:defclass MybuddyCoords (<MybuddyCoords>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MybuddyCoords>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MybuddyCoords)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mybuddy_communication-msg:<MybuddyCoords> is deprecated: use mybuddy_communication-msg:MybuddyCoords instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <MybuddyCoords>))
...
(cl:defmethod y-val ((m <MybuddyCoords>))
...
(cl:defmethod z-val ((m <MybuddyCoords>))
...
(cl:defmethod rx-val ((m <MybuddyCoords>))
...
(cl:defmethod ry-val ((m <MybuddyCoords>))
...
(cl:defmethod rz-val ((m <MybuddyCoords>))
  ...
  (rz m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MybuddyCoords>) ostream)
  "Serializes a message object of type '<MybuddyCoords>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MybuddyCoords>) istream)
  "Deserializes a message object of type '<MybuddyCoords>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MybuddyCoords>)))
  "Returns string type for a message object of type '<MybuddyCoords>"
  "mybuddy_communication/MybuddyCoords")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MybuddyCoords)))
  "Returns string type for a message object of type 'MybuddyCoords"
  "mybuddy_communication/MybuddyCoords")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MybuddyCoords>)))
  "Returns md5sum for a message object of type '<MybuddyCoords>"
  "740a0696f94797c91679d50dca7e75ad")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MybuddyCoords)))
  "Returns md5sum for a message object of type 'MybuddyCoords"
  "740a0696f94797c91679d50dca7e75ad")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MybuddyCoords>)))
  "Returns full string definition for message of type '<MybuddyCoords>"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 rx~%float32 ry~%float32 rz~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MybuddyCoords)))
  "Returns full string definition for message of type 'MybuddyCoords"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 rx~%float32 ry~%float32 rz~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MybuddyCoords>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MybuddyCoords>))
  "Converts a ROS message object to a list"
  (cl:list 'MybuddyCoords
    (cl:cons ':x (x msg))
    (cl:cons ':y (y msg))
    (cl:cons ':z (z msg))
    (cl:cons ':rx (rx msg))
