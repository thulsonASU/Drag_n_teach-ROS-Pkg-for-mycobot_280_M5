...
(cl:defmethod cl:initialize-instance :after ((m <SetAngles-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAngles-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mybuddy_communication-srv:<SetAngles-request> is deprecated: use mybuddy_communication-srv:SetAngles-request instead.")))

(cl:ensure-generic-function 'joint_0-val :lambda-list '(m))
(cl:defmethod joint_0-val ((m <SetAngles-request>))
...
(cl:defmethod joint_8-val ((m <SetAngles-request>))
...
(cl:defmethod joint_9-val ((m <SetAngles-request>))
...
(cl:defmethod joint_10-val ((m <SetAngles-request>))
...
(cl:defmethod joint_11-val ((m <SetAngles-request>))
...
(cl:defmethod joint_12-val ((m <SetAngles-request>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetAngles-request>)))
  ...
  "mybuddy_communication/SetAnglesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles-request)))
  "Returns string type for a service object of type 'SetAngles-request"
  "mybuddy_communication/SetAnglesRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetAngles-request>)))
  ...
  "9d0765c7fea1de2870e482fc85d83cb1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetAngles-request)))
  "Returns md5sum for a message object of type 'SetAngles-request"
  "9d0765c7fea1de2870e482fc85d83cb1")
...
(cl:defmethod cl:initialize-instance :after ((m <SetAngles-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAngles-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mybuddy_communication-srv:<SetAngles-response> is deprecated: use mybuddy_communication-srv:SetAngles-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetAngles-response>)))
  ...
  "mybuddy_communication/SetAnglesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles-response)))
  "Returns string type for a service object of type 'SetAngles-response"
  "mybuddy_communication/SetAnglesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles)))
  ...
  "mybuddy_communication/SetAngles")