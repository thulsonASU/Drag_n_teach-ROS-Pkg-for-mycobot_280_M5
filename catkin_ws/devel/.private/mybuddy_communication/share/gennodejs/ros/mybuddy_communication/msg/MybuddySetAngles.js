...
class MybuddySetAngles {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MybuddySetAngles(null);
  ...
  static datatype() {
    ...
    return 'mybuddy_communication/MybuddySetAngles';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MybuddySetAngles(null);
...
module.exports = MybuddySetAngles;
