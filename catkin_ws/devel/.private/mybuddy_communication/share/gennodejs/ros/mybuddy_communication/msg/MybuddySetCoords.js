...
class MybuddySetCoords {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MybuddySetCoords(null);
  ...
  static datatype() {
    ...
    return 'mybuddy_communication/MybuddySetCoords';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MybuddySetCoords(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = MybuddySetCoords;
