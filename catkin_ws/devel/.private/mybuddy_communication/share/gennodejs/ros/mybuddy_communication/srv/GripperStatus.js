...
class GripperStatusRequest {
  ...
  static datatype() {
    ...
    return 'mybuddy_communication/GripperStatusRequest';
  }
...
class GripperStatusResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'mybuddy_communication/GripperStatusResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'mybuddy_communication/GripperStatus'; }
};
