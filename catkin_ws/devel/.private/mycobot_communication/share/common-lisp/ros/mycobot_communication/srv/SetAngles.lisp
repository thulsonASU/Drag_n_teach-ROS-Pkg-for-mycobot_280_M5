...
(cl:defmethod cl:initialize-instance :after ((m <SetAngles-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAngles-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mycobot_communication-srv:<SetAngles-request> is deprecated: use mycobot_communication-srv:SetAngles-request instead.")))

(cl:ensure-generic-function 'joint_1-val :lambda-list '(m))
(cl:defmethod joint_1-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-srv:joint_1-val is deprecated.  Use mycobot_communication-srv:joint_1 instead.")
  (joint_1 m))

(cl:ensure-generic-function 'joint_2-val :lambda-list '(m))
(cl:defmethod joint_2-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-srv:joint_2-val is deprecated.  Use mycobot_communication-srv:joint_2 instead.")
  (joint_2 m))

(cl:ensure-generic-function 'joint_3-val :lambda-list '(m))
(cl:defmethod joint_3-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-srv:joint_3-val is deprecated.  Use mycobot_communication-srv:joint_3 instead.")
  (joint_3 m))

(cl:ensure-generic-function 'joint_4-val :lambda-list '(m))
(cl:defmethod joint_4-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-srv:joint_4-val is deprecated.  Use mycobot_communication-srv:joint_4 instead.")
  (joint_4 m))

(cl:ensure-generic-function 'joint_5-val :lambda-list '(m))
(cl:defmethod joint_5-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-srv:joint_5-val is deprecated.  Use mycobot_communication-srv:joint_5 instead.")
  (joint_5 m))

(cl:ensure-generic-function 'joint_6-val :lambda-list '(m))
(cl:defmethod joint_6-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-srv:joint_6-val is deprecated.  Use mycobot_communication-srv:joint_6 instead.")
  (joint_6 m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <SetAngles-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-srv:speed-val is deprecated.  Use mycobot_communication-srv:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetAngles-request>)))
  ...
  "mycobot_communication/SetAnglesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles-request)))
  "Returns string type for a service object of type 'SetAngles-request"
  "mycobot_communication/SetAnglesRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetAngles-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAngles-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mycobot_communication-srv:<SetAngles-response> is deprecated: use mycobot_communication-srv:SetAngles-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetAngles-response>)))
  ...
  "mycobot_communication/SetAnglesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles-response)))
  "Returns string type for a service object of type 'SetAngles-response"
  "mycobot_communication/SetAnglesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetAngles)))
  ...
  "mycobot_communication/SetAngles")