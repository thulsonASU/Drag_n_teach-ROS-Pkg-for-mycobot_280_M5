...
(cl:defmethod Pin1-val ((m <MycobotPumpStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-msg:Pin1-val is deprecated.  Use mycobot_communication-msg:Pin1 instead.")
  (Pin1 m))

(cl:ensure-generic-function 'Pin2-val :lambda-list '(m))
(cl:defmethod Pin2-val ((m <MycobotPumpStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-msg:Pin2-val is deprecated.  Use mycobot_communication-msg:Pin2 instead.")
  (Pin2 m))
