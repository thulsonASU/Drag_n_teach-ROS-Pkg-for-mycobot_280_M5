...
(cl:defmethod cl:initialize-instance :after ((m <MycobotSetAngles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MycobotSetAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mycobot_communication-msg:<MycobotSetAngles> is deprecated: use mycobot_communication-msg:MycobotSetAngles instead.")))

(cl:ensure-generic-function 'joint_1-val :lambda-list '(m))
(cl:defmethod joint_1-val ((m <MycobotSetAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-msg:joint_1-val is deprecated.  Use mycobot_communication-msg:joint_1 instead.")
  (joint_1 m))

(cl:ensure-generic-function 'joint_2-val :lambda-list '(m))
(cl:defmethod joint_2-val ((m <MycobotSetAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-msg:joint_2-val is deprecated.  Use mycobot_communication-msg:joint_2 instead.")
  (joint_2 m))

(cl:ensure-generic-function 'joint_3-val :lambda-list '(m))
(cl:defmethod joint_3-val ((m <MycobotSetAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-msg:joint_3-val is deprecated.  Use mycobot_communication-msg:joint_3 instead.")
  (joint_3 m))

(cl:ensure-generic-function 'joint_4-val :lambda-list '(m))
(cl:defmethod joint_4-val ((m <MycobotSetAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-msg:joint_4-val is deprecated.  Use mycobot_communication-msg:joint_4 instead.")
  (joint_4 m))

(cl:ensure-generic-function 'joint_5-val :lambda-list '(m))
(cl:defmethod joint_5-val ((m <MycobotSetAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-msg:joint_5-val is deprecated.  Use mycobot_communication-msg:joint_5 instead.")
  (joint_5 m))

(cl:ensure-generic-function 'joint_6-val :lambda-list '(m))
(cl:defmethod joint_6-val ((m <MycobotSetAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-msg:joint_6-val is deprecated.  Use mycobot_communication-msg:joint_6 instead.")
  (joint_6 m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <MycobotSetAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mycobot_communication-msg:speed-val is deprecated.  Use mycobot_communication-msg:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MycobotSetAngles>)))
  ...
  "mycobot_communication/MycobotSetAngles")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MycobotSetAngles)))
  "Returns string type for a message object of type 'MycobotSetAngles"
  "mycobot_communication/MycobotSetAngles")
