...
class PumpStatusRequest {
  ...
  static datatype() {
    ...
    return 'mypalletizer_communication/PumpStatusRequest';
  }
...
class PumpStatusResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'mypalletizer_communication/PumpStatusResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'mypalletizer_communication/PumpStatus'; }
};
