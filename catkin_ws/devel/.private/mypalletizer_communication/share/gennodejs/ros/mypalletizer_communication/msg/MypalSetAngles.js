...
class MypalSetAngles {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MypalSetAngles(null);
  ...
  static datatype() {
    ...
    return 'mypalletizer_communication/MypalSetAngles';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MypalSetAngles(null);
