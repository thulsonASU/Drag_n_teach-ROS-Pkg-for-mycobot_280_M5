...
class MypalPumpStatus {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MypalPumpStatus(null);
  ...
  static datatype() {
    ...
    return 'mypalletizer_communication/MypalPumpStatus';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MypalPumpStatus(null);
...
module.exports = MypalPumpStatus;
