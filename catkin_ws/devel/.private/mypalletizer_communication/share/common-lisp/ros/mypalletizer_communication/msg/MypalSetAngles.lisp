...
(cl:defclass <MypalSetAngles> (roslisp-msg-protocol:ros-message)
  ((joint_1
    :reader joint_1
    :initarg :joint_1
    :type cl:float
...
(cl:defclass MypalSetAngles (<MypalSetAngles>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MypalSetAngles>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MypalSetAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mypalletizer_communication-msg:<MypalSetAngles> is deprecated: use mypalletizer_communication-msg:MypalSetAngles instead.")))

(cl:ensure-generic-function 'joint_1-val :lambda-list '(m))
(cl:defmethod joint_1-val ((m <MypalSetAngles>))
...
(cl:defmethod joint_2-val ((m <MypalSetAngles>))
...
(cl:defmethod joint_3-val ((m <MypalSetAngles>))
...
(cl:defmethod joint_4-val ((m <MypalSetAngles>))
...
(cl:defmethod speed-val ((m <MypalSetAngles>))
  ...
  (speed m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MypalSetAngles>) ostream)
  "Serializes a message object of type '<MypalSetAngles>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MypalSetAngles>) istream)
  "Deserializes a message object of type '<MypalSetAngles>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MypalSetAngles>)))
  "Returns string type for a message object of type '<MypalSetAngles>"
  "mypalletizer_communication/MypalSetAngles")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MypalSetAngles)))
  "Returns string type for a message object of type 'MypalSetAngles"
  "mypalletizer_communication/MypalSetAngles")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MypalSetAngles>)))
  "Returns md5sum for a message object of type '<MypalSetAngles>"
  "f42d83ee18e829315c93fe377f61e648")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MypalSetAngles)))
  "Returns md5sum for a message object of type 'MypalSetAngles"
  "f42d83ee18e829315c93fe377f61e648")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MypalSetAngles>)))
  "Returns full string definition for message of type '<MypalSetAngles>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MypalSetAngles)))
  "Returns full string definition for message of type 'MypalSetAngles"
  (cl:format cl:nil "# float32 base~%float32 joint_1~%float32 joint_2~%float32 joint_3~%float32 joint_4~%# float32 joint_5~%# float32 joint_6~%~%int8 speed~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MypalSetAngles>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MypalSetAngles>))
  "Converts a ROS message object to a list"
  (cl:list 'MypalSetAngles
