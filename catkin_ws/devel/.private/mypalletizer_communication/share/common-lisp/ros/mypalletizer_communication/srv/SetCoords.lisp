...
(cl:defmethod cl:initialize-instance :after ((m <SetCoords-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCoords-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mypalletizer_communication-srv:<SetCoords-request> is deprecated: use mypalletizer_communication-srv:SetCoords-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mypalletizer_communication-srv:x-val is deprecated.  Use mypalletizer_communication-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mypalletizer_communication-srv:y-val is deprecated.  Use mypalletizer_communication-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mypalletizer_communication-srv:z-val is deprecated.  Use mypalletizer_communication-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'rx-val :lambda-list '(m))
(cl:defmethod rx-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mypalletizer_communication-srv:rx-val is deprecated.  Use mypalletizer_communication-srv:rx instead.")
  (rx m))
...
(cl:defmethod model-val ((m <SetCoords-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mypalletizer_communication-srv:model-val is deprecated.  Use mypalletizer_communication-srv:model instead.")
  (model m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCoords-request>)))
  ...
  "mypalletizer_communication/SetCoordsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCoords-request)))
  "Returns string type for a service object of type 'SetCoords-request"
  "mypalletizer_communication/SetCoordsRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetCoords-request>)))
  ...
  "09bb6605de65a0ada81d3779b54a5d09")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetCoords-request)))
  "Returns md5sum for a message object of type 'SetCoords-request"
  "09bb6605de65a0ada81d3779b54a5d09")
...
(cl:defmethod cl:initialize-instance :after ((m <SetCoords-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetCoords-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mypalletizer_communication-srv:<SetCoords-response> is deprecated: use mypalletizer_communication-srv:SetCoords-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetCoords-response>)))
  ...
  "mypalletizer_communication/SetCoordsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCoords-response)))
  "Returns string type for a service object of type 'SetCoords-response"
  "mypalletizer_communication/SetCoordsResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetCoords)))
  ...
  "mypalletizer_communication/SetCoords")