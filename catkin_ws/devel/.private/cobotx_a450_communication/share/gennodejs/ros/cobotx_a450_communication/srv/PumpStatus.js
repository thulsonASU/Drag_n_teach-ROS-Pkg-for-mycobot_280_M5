...
class PumpStatusRequest {
  ...
  static datatype() {
    ...
    return 'cobotx_a450_communication/PumpStatusRequest';
  }
...
class PumpStatusResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cobotx_a450_communication/PumpStatusResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'cobotx_a450_communication/PumpStatus'; }
};
