...
class SetCoordsRequest {
  ...
  static datatype() {
    ...
    return 'cobotx_a450_communication/SetCoordsRequest';
  }
...
class SetCoordsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'cobotx_a450_communication/SetCoordsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'cobotx_a450_communication/SetCoords'; }
};
