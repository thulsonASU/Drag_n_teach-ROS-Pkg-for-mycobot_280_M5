...
(cl:defclass <CobotXSetCoords> (roslisp-msg-protocol:ros-message)
  ((x
    :reader x
    :initarg :x
    :type cl:float
...
(cl:defclass CobotXSetCoords (<CobotXSetCoords>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <CobotXSetCoords>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'CobotXSetCoords)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cobotx_a450_communication-msg:<CobotXSetCoords> is deprecated: use cobotx_a450_communication-msg:CobotXSetCoords instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <CobotXSetCoords>))
...
(cl:defmethod y-val ((m <CobotXSetCoords>))
...
(cl:defmethod z-val ((m <CobotXSetCoords>))
...
(cl:defmethod rx-val ((m <CobotXSetCoords>))
...
(cl:defmethod ry-val ((m <CobotXSetCoords>))
...
(cl:defmethod rz-val ((m <CobotXSetCoords>))
...
(cl:defmethod speed-val ((m <CobotXSetCoords>))
...
(cl:defmethod model-val ((m <CobotXSetCoords>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cobotx_a450_communication-msg:model-val is deprecated.  Use cobotx_a450_communication-msg:model instead.")
  (model m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <CobotXSetCoords>) ostream)
  "Serializes a message object of type '<CobotXSetCoords>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CobotXSetCoords>) istream)
  "Deserializes a message object of type '<CobotXSetCoords>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CobotXSetCoords>)))
  "Returns string type for a message object of type '<CobotXSetCoords>"
  "cobotx_a450_communication/CobotXSetCoords")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CobotXSetCoords)))
  "Returns string type for a message object of type 'CobotXSetCoords"
  "cobotx_a450_communication/CobotXSetCoords")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CobotXSetCoords>)))
  "Returns md5sum for a message object of type '<CobotXSetCoords>"
  "bb3f2ea0468e5092b322ab1c2ccf8fe9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CobotXSetCoords)))
  "Returns md5sum for a message object of type 'CobotXSetCoords"
  "bb3f2ea0468e5092b322ab1c2ccf8fe9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CobotXSetCoords>)))
  "Returns full string definition for message of type '<CobotXSetCoords>"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 rx~%float32 ry~%float32 rz~%~%int8 speed~%int8 model~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CobotXSetCoords)))
  "Returns full string definition for message of type 'CobotXSetCoords"
  (cl:format cl:nil "float32 x~%float32 y~%float32 z~%float32 rx~%float32 ry~%float32 rz~%~%int8 speed~%int8 model~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <CobotXSetCoords>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <CobotXSetCoords>))
  "Converts a ROS message object to a list"
  (cl:list 'CobotXSetCoords
    (cl:cons ':x (x msg))
    (cl:cons ':y (y msg))
    (cl:cons ':z (z msg))
    (cl:cons ':rx (rx msg))
