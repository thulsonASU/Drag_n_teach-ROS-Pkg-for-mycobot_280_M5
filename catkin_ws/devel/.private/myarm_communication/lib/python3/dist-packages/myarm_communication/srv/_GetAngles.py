...
"""autogenerated by genpy from myarm_communication/GetAnglesRequest.msg. Do not edit."""
import codecs
import sys
...
class GetAnglesRequest(genpy.Message):
  ...
  _type = "myarm_communication/GetAnglesRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from myarm_communication/GetAnglesResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetAnglesResponse(genpy.Message):
  ...
  _type = "myarm_communication/GetAnglesResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
float32 joint_1
float32 joint_2
...
class GetAngles(object):
  _type          = 'myarm_communication/GetAngles'
  _md5sum = 'a5ee1c157b4205d64d317ae102e83e8c'
