...
// (in-package myarm_communication.msg)
...
class MyArmSetAngles {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MyArmSetAngles(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MyArmSetAngles(null);
