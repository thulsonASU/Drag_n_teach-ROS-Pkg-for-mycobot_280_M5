...
;//! \htmlinclude MyArmSetAngles.msg.html

(cl:defclass <MyArmSetAngles> (roslisp-msg-protocol:ros-message)
  ((joint_1
    :reader joint_1
    :initarg :joint_1
    :type cl:float
...
(cl:defclass MyArmSetAngles (<MyArmSetAngles>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MyArmSetAngles>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MyArmSetAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myarm_communication-msg:<MyArmSetAngles> is deprecated: use myarm_communication-msg:MyArmSetAngles instead.")))

(cl:ensure-generic-function 'joint_1-val :lambda-list '(m))
(cl:defmethod joint_1-val ((m <MyArmSetAngles>))
...
(cl:defmethod joint_2-val ((m <MyArmSetAngles>))
...
(cl:defmethod joint_3-val ((m <MyArmSetAngles>))
...
(cl:defmethod joint_4-val ((m <MyArmSetAngles>))
...
(cl:defmethod joint_5-val ((m <MyArmSetAngles>))
...
(cl:defmethod joint_6-val ((m <MyArmSetAngles>))
...
(cl:defmethod joint_7-val ((m <MyArmSetAngles>))
...
(cl:defmethod speed-val ((m <MyArmSetAngles>))
  ...
  (speed m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MyArmSetAngles>) ostream)
  "Serializes a message object of type '<MyArmSetAngles>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MyArmSetAngles>) istream)
  "Deserializes a message object of type '<MyArmSetAngles>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MyArmSetAngles>)))
  "Returns string type for a message object of type '<MyArmSetAngles>"
  "myarm_communication/MyArmSetAngles")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MyArmSetAngles)))
  "Returns string type for a message object of type 'MyArmSetAngles"
  "myarm_communication/MyArmSetAngles")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MyArmSetAngles>)))
  "Returns md5sum for a message object of type '<MyArmSetAngles>"
  "05fb09131f8ece3ce865d4dd869613bb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MyArmSetAngles)))
  "Returns md5sum for a message object of type 'MyArmSetAngles"
  "05fb09131f8ece3ce865d4dd869613bb")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MyArmSetAngles>)))
  "Returns full string definition for message of type '<MyArmSetAngles>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MyArmSetAngles)))
  "Returns full string definition for message of type 'MyArmSetAngles"
  (cl:format cl:nil "float32 joint_1~%float32 joint_2~%float32 joint_3~%float32 joint_4~%float32 joint_5~%float32 joint_6~%float32 joint_7~%~%int8 speed~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MyArmSetAngles>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MyArmSetAngles>))
  "Converts a ROS message object to a list"
  (cl:list 'MyArmSetAngles
